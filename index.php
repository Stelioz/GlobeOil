    ...
    <div class="wrapper">
        ...
        <section class="prices">
            ...
            <ul class="unleaded95"> <!-- Τιμές για Βενζίνη 95 -->
                    <li><h2>Τιμή Αμόλυβδης Βενζίνης 95</h2></li>
                ...
                <ul class="unleaded98"> <!-- Τιμές για Βενζίνη 98 -->
                    <li><h2>Τιμή Αμόλυβδης Βενζίνης 98</h2></li>
                ...
                <ul class="unleaded100"> <!-- Τιμές για Βενζίνη 100 -->
                    <li><h2>Τιμή Αμόλυβδης Βενζίνης 100</h2></li>
                ...
                <ul class="diesel"> <!-- Τιμές για Πετρέλαιο Κίνησης -->
                    <li><h2>Τιμή Πετρελαίου Κίνησης</h2></li>
